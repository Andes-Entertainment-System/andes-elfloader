...
} typedef ELFLoaderSymbol_t ELFLoaderSymbol_t;
...
typedef ELFLoaderEnv_t ELFLoaderEnv_t;
...
typedef ELFLoaderSection_t ELFLoaderSection_t;
...
typedef ELFLoaderContext_t ELFLoaderContext_t;
